...
pnpm check          # lint + format + typecheck (the full CI gate)
pnpm lint           # oxlint
pnpm format         # oxfmt --check
pnpm format:write   # oxfmt (fix in place)
pnpm typecheck      # tsc --noEmit
pnpm vitals         # Core Web Vitals check against production (PageSpeed API)
```
